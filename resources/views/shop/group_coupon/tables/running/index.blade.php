<div class="row">
    <div class="col-xs-12">
        <div class="box" id = "ruuning-box">
            <div class="box-body" id="running-box-body">
                <table id="running_groupon_table"
...
<script>
    $(document).ready(function () {
        runningActivityController = {
            status:'running',
            page:1,
            listUrl:'',
            deleteUrl:'',
            $table:$('#running_groupon_table'),
            search:'',
            columns:function () {
                var self = this;
                return [
            ...
            queryParams: function (params){
                params['status'] = runningActivityController.status;
                params['order'] = 'desc';
                return params;
            },
            reset:function () {
                var self = this;
                $('.nav-tabs li[data-status="running"]').addClass('active');
                $('.tab-content .tab-pane#running').addClass('active');
                this.$table.bootstrapTable('refresh');
            },
            leave:function () {
                var self = this;
                $('.nav-tabs li[data-status="running"]').removeClass('active');
                $('.tab-content .tab-pane#running').removeClass('active');
                this.$table.bootstrapTable('refresh');
            }
        };
        runningActivityController.initTable();
    });
</script>
@endpush