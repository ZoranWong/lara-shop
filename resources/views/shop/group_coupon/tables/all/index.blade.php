<div class="row">
    <div class="col-xs-12">
        <div class="box" id = "all-box">
            <div class="box-body" id="all-box-body">
                <table id="all_groupon_table"
...
//            },
            reset:function () {
                var self = this;
                $('.nav-tabs li[data-status="all"]').addClass('active');
                $('.tab-content .tab-pane#all').addClass('active');
                this.$table.bootstrapTable('refresh');
            },
            leave:function () {
                var self = this;
                $('.nav-tabs li[data-status="all"]').removeClass('active');
                $('.tab-content .tab-pane#all').removeClass('active');
                this.$table.bootstrapTable('refresh');
            },
            ...
            queryParams: function (params){
                params['status'] = allActivityController.status;
                params['order'] = 'desc';
                return params;
            }
        };
        allActivityController.initTable();
    });
</script>
@endpush