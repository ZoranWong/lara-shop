            ...
            <form class="form-horizontal" id="form" autocomplete="off">
              <div class="box-body">
                <div class="form-group  has-feedback">
                  <label for="inputName" class="col-sm-2 control-label">角色名</label>
                  <div class="col-sm-10">
                  ...
                  <div class="form-group  has-feedback">
                      <label for="inputName" class="col-sm-2 control-label">显示名称</label>
                      <div class="col-sm-10">
      ...
      $(document).ready(function () {
          $('#form').validator().on('submit', function (e) {
              if(!e.isDefaultPrevented()){
                  ...
                  $.post('/ajax/role/create' , data , function (json) {
                      if(json.code == 200 ){
                          bootbox.alert({
