    ...
    $(document).ready(function () {
        ...
        $('#tran-download').click(function(){
            if (total_rows_tran > 0) {
                ...
                var url = "http://"+window.location.host+"/ajax/distributon/cash/list?order=asc&load=1&status=2&tran_cash_id="+tran_cash_id+"&tran_nickname="+tran_nickname+"&tran_name="+tran_name+"&tran_mobile="+tran_mobile+"&tran_apply_time="+tran_apply_time;
                window.open(url);
            } else {
                bootbox.alert({
