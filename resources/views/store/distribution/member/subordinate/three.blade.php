    ...
    <form class="form-horizontal" id="form_three">
        ...
        <div class="col-md-3">
            <div class="input-group col-md-12">
                ...
                <select class="select form-control" name="level_id" id="level_name_three">
                    <option value="">请选择</option>
                </select>
            </div>
        </div>
...
<div class="box-body">
    <table id="table_three"
           ...
           data-url="/ajax/fenxiao/member/list/{{ $id }}/3" 
...
<script type="text/javascript">
    window.pageInit = function () {
            ...
            $table_three.bootstrapTable({
                ...
                'queryParams': function(params){
                    ...
                    arr.forEach(function(item){
                        if($('#form_three [name='+item+']').val() == '' || typeof($('#form_three [name='+item+']').val()) == 'undefined' ) {

                        } else {
                            params[item] = $('#form_three [name='+item+']').val();
                        }
                    });
                    return params;
                }
        ...
        $.getJSON('/ajax/fenxiao/level/name',function(json){
            ...
            $('#level_name_three').append(level_text);
        })
    }
</script>