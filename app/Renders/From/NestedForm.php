...
class NestedForm
{
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \App\Renders\From\Field\Hidden) || $value != $field->original()) {
                if (is_array($columns)) {
    ...
    public function getTemplateHtmlAndScript()
    {
        ...
        foreach ($this->fields() as $field) {
            ...
            /*
             * Get and remove the last script of SectionContent::$script stack.
             */
            if ($field->getScript()) {
                $scripts[] = array_pop(SectionContent::$script);
            }
        }
