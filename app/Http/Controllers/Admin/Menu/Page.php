...
class Page extends BasePage
{
    ...
    protected function buildForm(Form $form, $id = null): BasePage
    {
        ...
        $form->text('text', trans('admin.title'))->rules('required');
        $form->icon('icon', trans('admin.icon'))->default('fa-bars')->rules('required')->help($this->iconHelp());
        $form->text('url', trans('admin.uri'));
        $form->multipleSelect('permission.roles', trans('admin.roles'))->options(Role::where('id', '!=', User::SUPER_ADMIN_ID)->get()->pluck('display_name', 'id'));
